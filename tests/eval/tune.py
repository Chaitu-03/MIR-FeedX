...
async def _eval_config(
    ...
    original = {
        "post_weight_text": settings.post_weight_text,
        "post_weight_image": settings.post_weight_image,
        "post_weight_tag": settings.post_weight_tag,
        "rrf_k": settings.rrf_k,
        "note_count_boost": settings.note_count_boost,
    }
    settings.post_weight_text = config["w_t"]
    settings.post_weight_image = config["w_i"]
    settings.post_weight_tag = config["w_g"]
